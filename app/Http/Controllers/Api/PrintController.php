...
class PrintController extends Controller
{
    ...
    public function print_reportex($data,$data2,$data4){
        ...
        $impresora->text("--------------------------------\n");
        $impresora->text("Reporte emitido"."\n");
        $impresora->text("\n");
        $impresora->text("Desde ". $ticket_dato_empresa['fecha_inicio']."\n");
        $impresora->text("Hasta ". $ticket_dato_empresa['fecha_fin']."\n");
        $impresora->text("--------------------------------\n");
